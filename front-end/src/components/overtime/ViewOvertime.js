                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Overtime by: {record.user.name}</h5>
                        ...
                        <div className="modal-body">
                            <div>
                                <div>
                                    {/* Bug here */}
                                    <p><span className={'fw-bold'}>Overtime in hours: </span>{record.duration}</p>
